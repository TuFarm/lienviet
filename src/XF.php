...
class XF
{
	...
	{
		return '<a class="u-concealed" dir="ltr" target="_blank" rel="sponsored noopener">Diễn đàn trường Liên Việt Kon Tum<sup>&reg;</sup> <span class="copyright">&copy; 2022 LienVietForum.</span></a>';
	}

	public static function getCopyrightHtmlAcp()
	{
		return '<a class="u-concealed" dir="ltr" target="_blank" rel="sponsored noopener" data-xf-init="tooltip" title="&copy; 2022 LienVietForum.">Community platform by XenForo<sup>&reg;</sup></a>';
	}
