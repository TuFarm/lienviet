...
return array (
  ...
  'style_prop_desc.siropuChatActiveUserCountBadgeColor' => 'The color of the user count badge for chat navigation and tabs when there are active users in the chat.',
  'style_prop_desc.siropuChatActiveUserCountColor' => 'The color of the user count for chat navigation and tabs when there are active users in the chat.',
  'style_prop_desc.siropuChatAnnouncement' => 'Styling of the message row for announcements.',
  'style_prop_desc.siropuChatBarButton' => 'The bar button that displays the number of chat users.',
  'style_prop_desc.siropuChatBarContainer' => 'The chat bar that shows up at the bottom of the screen when using "All pages" mode.',
  'style_prop_desc.siropuChatContainer' => 'The main chat container.',
  'style_prop_desc.siropuChatContentHeight' => 'The height of the chat content.',
  'style_prop_desc.siropuChatContentHeightMobile' => 'The height of the chat content on mobile devices.',
  'style_prop_desc.siropuChatConversationListItem' => 'Individual item in the conversation user list.',
  'style_prop_desc.siropuChatConversationListItemActive' => 'Individual item in the conversation user list, active state.',
  'style_prop_desc.siropuChatConversationListItemHover' => 'Individual item in the conversation user list, hover state.',
  'style_prop_desc.siropuChatDateTime' => 'Styling of the message date.',
  'style_prop_desc.siropuChatDeleteIconColor' => 'The color of the delete icon.',
  'style_prop_desc.siropuChatEditIconColor' => 'The color of the edit icon.',
  'style_prop_desc.siropuChatEditorInput' => 'The chat editor input box.',
  'style_prop_desc.siropuChatEditorToolbar' => 'The chat editor toolbar.',
  'style_prop_desc.siropuChatHelpIconColor' => 'The color of the help icon.',
  'style_prop_desc.siropuChatIconFontSize' => 'The font size of all the icons used in the chat.',
  'style_prop_desc.siropuChatLikeIconColor' => 'The color of the like icon.',
  'style_prop_desc.siropuChatLinkIconColor' => 'The color of the link icon.',
  'style_prop_desc.siropuChatMaximizedContentHeight' => 'The height of the chat content in maximized mode.',
  'style_prop_desc.siropuChatMessageText' => 'Styling of the message text.',
  'style_prop_desc.siropuChatNoUserCountBadgeColor' => 'The color of the user count badge for chat navigation and tabs when there are no active users in the chat.',
  'style_prop_desc.siropuChatNoUserCountColor' => 'The color of the user count for chat navigation and tabs when there are no active users in the chat.',
  'style_prop_desc.siropuChatOptionsIconColor' => 'The color of the options icon.',
  'style_prop_desc.siropuChatPageContentHeight' => 'The height of the chat content on the dedicated chat page.',
  'style_prop_desc.siropuChatQuoteIconColor' => 'The color of the quote icon.',
  'style_prop_desc.siropuChatReportIconColor' => 'The color of the report icon.',
  'style_prop_desc.siropuChatRoomListItem' => 'Individual room list item.',
  'style_prop_desc.siropuChatRulesIconColor' => 'The color of the rules icon.',
  'style_prop_desc.siropuChatSanctionIconColor' => 'The color of the sanction icon.',
  'style_prop_desc.siropuChatSettingsIconColor' => 'The color of the settings icon.',
  'style_prop_desc.siropuChatTabsContainer' => 'The container of the tabs.',
  'style_prop_desc.siropuChatTabsItem' => 'Individual tab item default state.',
  'style_prop_desc.siropuChatTabsItemActive' => 'Individual tab item active state.',
  'style_prop_desc.siropuChatTabsItemBadge' => 'Individual tab item user count badge.',
  'style_prop_desc.siropuChatTabsItemHover' => 'Individual tab item hover state.',
  'style_prop_desc.siropuChatUnlikeIconColor' => 'The color of the unlike icon.',
  'style_prop_desc.siropuChatUserMention' => 'Styling of the message row container for user mentions.',
  'style_prop_desc.siropuChatUserMentionDate' => 'Styling of the message row date for user mentions.',
  'style_prop_desc.siropuChatUserStatus' => 'Styling of the user status.',
  'style_prop_desc.siropuChatUsersIconColor' => 'The color of the users icon.',
  'style_prop_desc.siropuChatWhosTypingContainer' => 'Style the container of "who\'s typing" list.',
