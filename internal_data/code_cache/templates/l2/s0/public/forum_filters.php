...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['prefixes'], 'empty', array())) {
		...
		<div class="menu-row menu-row--separated">
			...
			'name' => 'prefix_id',
			'noneLabel' => $__vars['xf']['language']['parenthesis_open'] . 'Mọi' . $__vars['xf']['language']['parenthesis_close'],
		), $__vars) . '
			</div>
		</div>
	';
	...
	' . '
	<div class="menu-row menu-row--separated">
		<label for="ctrl_last_updated">' . 'Cập nhật lần cuối' . $__vars['xf']['language']['label_separator'] . '</label>
		<div class="u-inputSpacer">
			' . $__compilerTemp2 . '
