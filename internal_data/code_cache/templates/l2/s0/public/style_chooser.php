...
<div class="block">
	...
	if ($__vars['style']) {
		...
		$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('misc/style', null, array('style_id' => 0, '_xfRedirect' => $__vars['redirect'], 't' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow menu-linkRow--alt">' . 'Dùng giao diện mặc định' . '</a>
			<div class="block-body">
