	...
	<div class="block"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
		...
		if ($__vars['style'] == 'full') {
			...
			if (!$__templater->test($__vars['threads'], 'empty', array())) {
				...
				$__finalCompiled .= '
							<div class="block-row">
								' . 'Bạn không có bài viết chưa đọc. Thay vào đó, bạn có thể <a href="' . $__templater->func('link', array('whats-new/posts', null, array('skip' => 1, ), ), true) . '" rel="nofollow">xem tất cả các bài đăng mới nhất</a>.' . '
							</div>
						';
			} else {
				$__finalCompiled .= '
