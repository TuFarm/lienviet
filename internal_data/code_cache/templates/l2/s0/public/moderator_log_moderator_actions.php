...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['title'] ? ($__templater->escape($__vars['title']) . ' - ') : '') . 'Hành vi quản trị');
	$__finalCompiled .= '
		...
		if ($__vars['hasNext']) {
			$__finalCompiled .= '
					<span class="block-footer-controls">' . $__templater->button('
						' . 'Tiếp tục' . $__vars['xf']['language']['ellipsis'] . '
					', array(
