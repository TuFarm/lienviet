<?php
// FROM HASH: 4bbaedc4ca239597d263b27aed9a2d20
return array(
	...
	if ($__templater->method($__vars['user'], 'canViewIdentities', array())) {
		...
		if ($__templater->method($__vars['xf']['visitor'], 'canStartConversationWith', array($__vars['user'], ))) {
			$__compilerTemp4 .= '
								<dl class="pairs pairs--columns pairs--fixedSmall">
									<dt>' . 'Đối thoại' . '</dt>
									<dd><a href="' . $__templater->func('link', array('conversations/add', '', array('to' => $__vars['user']['username'], ), ), true) . '">' . 'Bắt đầu đối thoại' . '</a></dd>
								</dl>
							';
		}
		$__compilerTemp4 .= '
