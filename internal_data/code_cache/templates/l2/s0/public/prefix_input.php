	...
	<script type="text/template">
		...
		<div class="menu-row">
			<a class="menuPrefix menuPrefix--none"
				data-prefix-id="0"
				data-prefix-class=""
				role="option">' . $__vars['xf']['language']['parenthesis_open'] . 'Chọn Địa phương' . $__vars['xf']['language']['parenthesis_close'] . '</a>
		</div>
	</script>
';
			...
			<div class="inputGroup-text">
				...
				>
					<a class="menuTrigger menuTrigger--prefix" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">
						<span class="js-activePrefix">' . $__vars['xf']['language']['parenthesis_open'] . 'Chọn Địa phương' . $__vars['xf']['language']['parenthesis_close'] . '</span>
					</a>
