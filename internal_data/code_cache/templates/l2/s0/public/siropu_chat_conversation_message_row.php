...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['message'], 'canLike', array())) {
		...
		if ($__vars['xf']['options']['siropuChatReactions']) {
			...
			if ($__templater->method($__vars['message'], 'isLiked', array())) {
				$__compilerTemp1 .= '
								<a href="' . $__templater->func('link', array('chat/conversation/unlike', $__vars['message'], ), true) . '" title="' . $__templater->filter('Không thích nữa', array(array('for_attr', array()),), true) . '" data-xf-click="siropu-chat-unlike">' . $__templater->fontAwesome('fa-thumbs-down', array(
				)) . ' <span>' . 'Không thích nữa' . '</span></a>
							';
			} else {
				$__compilerTemp1 .= '
								<a href="' . $__templater->func('link', array('chat/conversation/like', $__vars['message'], ), true) . '" title="' . $__templater->filter('Thích', array(array('for_attr', array()),), true) . '" data-xf-click="siropu-chat-like">' . $__templater->fontAwesome('fa-thumbs-up', array(
				)) . ' <span>' . 'Thích' . '</span></a>
							';
			}
			$__compilerTemp1 .= '
	...
	if ($__templater->method($__vars['message'], 'canQuote', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('chat/conversation/quote', $__vars['message'], ), true) . '" title="' . $__templater->filter('Trích dẫn', array(array('for_attr', array()),), true) . '" data-xf-click="siropu-chat-quote">' . $__templater->fontAwesome('fa-quote-right', array(
		)) . ' <span>' . 'Trích dẫn' . '</span></a>
					';
	}
	$__compilerTemp1 .= '
					';
	if ($__templater->method($__vars['message'], 'canLink', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('chat/conversation/link', $__vars['message'], ), true) . '" title="' . $__templater->filter('Link', array(array('for_attr', array()),), true) . '" data-xf-click="overlay">' . $__templater->fontAwesome('fa-link', array(
		)) . ' <span>' . 'Link' . '</span></a>
					';
	}
	$__compilerTemp1 .= '
	...
	if ($__templater->method($__vars['message'], 'canReport', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('chat/conversation/report', $__vars['message'], ), true) . '" title="' . $__templater->filter('Báo cáo', array(array('for_attr', array()),), true) . '" data-xf-click="overlay" data-cache="false">' . $__templater->fontAwesome('fa-flag', array(
		)) . ' <span>' . 'Báo cáo' . '</span></a>
					';
	}
	$__compilerTemp1 .= '
	...
	if ($__templater->method($__vars['message'], 'canEditDelete', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('chat/conversation/edit', $__vars['message'], ), true) . '" title="' . $__templater->filter('Sửa', array(array('for_attr', array()),), true) . '" data-xf-click="overlay" data-cache="false">' . $__templater->fontAwesome('fa-edit', array(
		)) . ' <span>' . 'Sửa' . '</span></a>
					';
	}
	$__compilerTemp1 .= '
	...
	if ($__templater->method($__vars['message'], 'canEditDelete', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('chat/conversation/delete', $__vars['message'], ), true) . '" title="' . $__templater->filter('Xóa', array(array('for_attr', array()),), true) . '" data-xf-click="overlay" data-cache="false">' . $__templater->fontAwesome('fa-trash-alt', array(
		)) . ' <span>' . 'Xóa' . '</span></a>
					';
	}
	$__compilerTemp1 .= '
