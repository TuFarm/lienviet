...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a class="' . $__templater->escape($__vars['linkClass']) . ' menuTrigger"
		...
		tabindex="0"
		aria-expanded="false"
		aria-haspopup="true">' . 'Add-on' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['currentAddOn'] ? $__templater->escape($__vars['currentAddOn']['title']) : $__vars['xf']['language']['parenthesis_open'] . 'Mọi' . $__vars['xf']['language']['parenthesis_close']) . '</a>
	...
	<div class="menu" data-menu="menu" aria-hidden="true">
		<div class="menu-content">
			...
			<a href="' . $__templater->func('link', array($__vars['route'], $__vars['routeData'], array('addon_id' => null, ) + $__vars['routeParams'], ), true) . '"
				...
				' . $__vars['xf']['language']['parenthesis_open'] . 'Mọi' . $__vars['xf']['language']['parenthesis_close'] . '
			</a>
			';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['includeAny']) {
		$__compilerTemp1[] = array(
			'value' => '_any',
			'label' => $__vars['xf']['language']['parenthesis_open'] . 'Mọi' . $__vars['xf']['language']['parenthesis_close'],
			'_type' => 'option',
		);
	}
