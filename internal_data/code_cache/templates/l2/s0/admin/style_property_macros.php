...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['definitionEditable']) {
		$__compilerTemp3 .= '
			<a href="' . $__templater->func('link', array('style-properties/edit', $__vars['property'], ), true) . '">' . 'Sửa' . '</a>
		';
	}
	$__compilerTemp4 = '';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['property'], 'isValidCssComponent', array('border', )) OR $__templater->method($__vars['property'], 'isValidCssComponent', array('border_radius', ))) {
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Bên trên' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Bên phải' . '</td>
		...
		$__finalCompiled .= '
							...
							<tr>
								<td class="cssPropertySet-rowLabel">' . 'Bên trái' . '</td>
