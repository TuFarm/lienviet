<?php
// FROM HASH: 354e0da21ab05c68113b7941bcb2126c
return array(
		...
		if (!$__vars['showingAll']) {
			...
			<div class="block-outer">
				<div class="block-outer-main">
					' . $__templater->button('
						' . 'Sắp xếp theo' . $__vars['xf']['language']['label_separator'] . ' ' . ($__templater->escape($__vars['sortOptions'][$__vars['order']]) ?: 'Tên tài khoản') . '
					', array(
