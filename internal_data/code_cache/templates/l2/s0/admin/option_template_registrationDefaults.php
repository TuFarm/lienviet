...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="u-inputSpacer">
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_cws">' . 'Theo dõi nội dung vừa tạo' . '</label></dt>
	...
	array(
		...
		<dl class="inputLabelPair">
			<dt><label for="' . $__templater->escape($__vars['inputName']) . '_iws">' . 'Theo dõi nội dung vừa tương tác' . '</label></dt>
			<dd>' . $__templater->formSelect(array(
