...
';
	...
	if ((!$__vars['existingType']) OR ($__vars['existingType']['options'] == 'choice')) {
		...
		$__compilerTemp5 .= $__templater->formRow('
			...
			'explain' => 'The value represents the internal value for the choice. The text field is shown when the field is displayed.',
		)) . '
			</div>
		';
	}
