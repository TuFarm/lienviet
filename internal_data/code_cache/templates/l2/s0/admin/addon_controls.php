...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (($__templater->method($__vars['addOn'], 'isInstalled', array()) OR $__templater->method($__vars['addOn'], 'canUpgrade', array())) AND (!$__templater->method($__vars['addOn'], 'isLegacy', array()))) {
		$__compilerTemp3 .= '
					<a href="' . $__templater->func('link', array('add-ons/toggle', $__vars['addOn'], array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '" class="menu-linkRow">' . ($__vars['addOn']['active'] ? 'Tắt' : 'Bật') . '</a>
				';
	}
	$__compilerTemp3 .= '
				';
