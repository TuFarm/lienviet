...
';
		...
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Edit Warning Action' . $__vars['xf']['language']['label_separator'] . ' ' . 'Điểm' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['action']['points']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
