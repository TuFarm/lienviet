...
';
	...
	' . $__templater->button('Đặt lại', array(
...
';
	...
	<div class="block-container">
		...
		'explain' => 'The message to be shown when the display criteria are met. You may insert <b>{name}</b> to be replaced with the current visitor\'s username.',
	)) . '
