...
<div class="block">
	...
	<div class="block-container">
		...
		'phrases' => array('key:addon_id' => 'Add-on' . $__vars['xf']['language']['label_separator'], 'key:title' => 'Title Contains' . $__vars['xf']['language']['label_separator'], 'key:text' => 'Text Contains' . $__vars['xf']['language']['label_separator'], 'key:text_cs' => 'Case sensitive', 'key:state' => 'Phrase Status' . $__vars['xf']['language']['label_separator'], 'val:_none' => 'Không có', 'val:default' => 'Unmodified', 'val:inherited' => 'Modified in a parent language', 'val:custom' => 'Modified in this language', ),
