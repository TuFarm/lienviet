...
<div class="block">
	...
	<div class="block-container">
		...
		'phrases' => array('key:type' => 'Template type' . $__vars['xf']['language']['label_separator'], 'key:addon_id' => 'Add-on' . $__vars['xf']['language']['label_separator'], 'key:title' => 'Title Contains' . $__vars['xf']['language']['label_separator'], 'key:template' => 'Text Contains' . $__vars['xf']['language']['label_separator'], 'key:template_cs' => 'Case sensitive', 'key:state' => 'Template Status' . $__vars['xf']['language']['label_separator'], 'val:_none' => 'Không có', 'val:default' => 'Unmodified', 'val:inherited' => 'Modified in a parent style', 'val:custom' => 'Modified in this style', ),
