...
<p>Gần đây bạn đã đăng nhập vào tài khoản của mình tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ' và hoàn tất xác minh hai bước thông qua mã dự phòng. Mã dự phòng chỉ nên được sử dụng khi bạn không có quyền truy cập vào phương pháp xác minh khác.</p>
