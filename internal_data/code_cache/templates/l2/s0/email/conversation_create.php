...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . $__templater->escape($__vars['sender']['username']) . ' bắt đầu một cuộc trò chuyện với bạn: "' . $__templater->escape($__vars['conversation']['title']) . '"' . '
</mail:subject>

' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->escape($__vars['sender']['username']) . ' bắt đầu một cuộc trò chuyện cá nhân mới với bạn tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
...
<tr>
	...
	<td align="' . ($__vars['xf']['isRtl'] ? 'left' : 'right') . '">
		<a href="' . $__templater->func('link', array('canonical:conversations', ), true) . '" class="buttonFake">' . 'Xem tất cả các cuộc hội thoại' . '</a>
	</td>
</tr>
</table>
