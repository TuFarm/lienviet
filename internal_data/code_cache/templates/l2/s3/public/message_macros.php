...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['options']['showMessageOnlineStatus'] AND ($__vars['user'] AND $__templater->method($__vars['user'], 'isOnline', array()))) {
		$__finalCompiled .= '
					<span class="message-avatar-online" tabindex="0" data-xf-init="tooltip" data-trigger="auto" title="' . $__templater->filter('Đang trực tuyến', array(array('for_attr', array()),), true) . '"></span>
				';
	}
	$__finalCompiled .= '
			</div>
	...
	if ($__vars['user']['user_id']) {
		...
		if ($__vars['extras']['register_date']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Tham gia', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['message_count']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Bài viết', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['solutions'] AND $__vars['user']['question_solution_count']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Solutions', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['reaction_score']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Điểm tương tác', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['trophy_points'] AND $__vars['xf']['options']['enableTrophies']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Điểm', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['age'] AND $__vars['user']['Profile']['age']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Tuổi', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['location'] AND $__vars['user']['Profile']['location']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Địa chỉ', array(array('for_attr', array()),), true) . '">
		...
		if ($__vars['extras']['website'] AND $__vars['user']['Profile']['website']) {
			...
			if ($__templater->func('property', array('uix_postBitIcons', ), false)) {
				$__compilerTemp1 .= '
												<dt>
													<span data-xf-init="tooltip" title="' . $__templater->filter('Website', array(array('for_attr', array()),), true) . '">
			...
			$__compilerTemp1 .= '
											<dd data-xf-init="tooltip" title="' . $__templater->filter($__vars['user']['Profile']['website'], array(array('url', array('host', 'Ghé thăm trang', )),), true) . '"><a href="' . $__templater->escape($__vars['user']['Profile']['website']) . '" rel="nofollow" target="_blank">' . $__templater->filter($__vars['user']['Profile']['website'], array(array('url', array('host', 'Ghé thăm trang', )),), true) . '</a></dd>
										</dl>
									';
		}
		$__compilerTemp1 .= '
