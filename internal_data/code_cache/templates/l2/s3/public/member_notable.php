<?php
// FROM HASH: 02deb10a34a91ab2672608f6ffbe1d25
return array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['active'] ? $__templater->escape($__vars['active']['title']) : 'Thành viên đáng chú ý'));
	$__finalCompiled .= '
