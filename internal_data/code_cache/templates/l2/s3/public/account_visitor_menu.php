<?php
// FROM HASH: ea95ef864517f760bc29c1914aa1bb05
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canUploadAvatar', array())) {
		$__finalCompiled .= '
						<a class="avatarWrapper-update" href="' . $__templater->func('link', array('account/avatar', ), true) . '" data-xf-click="overlay"><span>' . 'Sửa' . '</span></a>
					';
	}
	$__finalCompiled .= '
				</span>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1 = '';
	$__compilerTemp1 .= '
					<a href="' . $__templater->func('link', array('conversations', ), true) . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['conversations_unread'], array(array('number', array()),), true) . '" class="tabs-tab js-badge--conversations badgeContainer' . ($__vars['xf']['visitor']['conversations_unread'] ? ' badgeContainer--highlighted' : '') . '" role="tab" tabindex="0" aria-controls="uix_conversationsMenuPanel" data-nocache="true">' . $__templater->fontAwesome('fa-envelope', array(
	)) . '</a>
					<a href="' . $__templater->func('link', array('account/alerts', ), true) . '" data-badge="' . $__templater->filter($__vars['xf']['visitor']['alerts_unviewed'], array(array('number', array()),), true) . '" class="tabs-tab js-badge--alerts badgeContainer' . ($__vars['xf']['visitor']['alerts_unviewed'] ? ' badgeContainer--highlighted' : '') . '" role="tab" tabindex="0" data-nocache="true">' . $__templater->fontAwesome('fa-bell', array(
	)) . '</a>
					';
	if ($__templater->method($__vars['xf']['visitor'], 'canViewBookmarks', array())) {
		$__compilerTemp1 .= '
						<a href="' . $__templater->func('link', array('account/bookmarks', ), true) . '" class="tabs-tab" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('accountMenuBookmarks', ), true) . '">' . $__templater->fontAwesome('fa-bookmark', array(
		)) . '</a>
					';
	}
	$__compilerTemp1 .= '
	...
	<h4 class="menu-tabHeader tabs" data-xf-init="tabs" role="tablist">
		<span class="hScroller" data-xf-init="h-scroller">
			<span class="hScroller-scroll">
				<a href="' . $__templater->func('link', array('account', ), true) . '" class="tabs-tab is-active" role="tab" tabindex="0" aria-controls="' . $__templater->func('unique_id', array('accountMenu', ), true) . '">' . $__templater->fontAwesome('fa-user', array(
		)) . '</a>
				' . $__compilerTemp1 . '
			</span>
		</span>
...
';
	...
	if ($__vars['xf']['options']['enableNewsFeed']) {
		$__compilerTemp2 .= '
			<li><a href="' . $__templater->func('link', array('whats-new/news-feed', ), true) . '" class="menu-linkRow">' . 'Dòng thời gian' . '</a></li>
		';
	}
	$__compilerTemp3 = '';
	...
	if ($__vars['xf']['app']['userUpgradeCount']) {
		$__compilerTemp4 .= '
			<li><a href="' . $__templater->func('link', array('account/upgrades', ), true) . '" class="menu-linkRow">' . 'Các gói nâng cấp' . '</a></li>
		';
	}
	$__compilerTemp5 = '';
	if ($__vars['xf']['app']['connectedAccountCount']) {
		$__compilerTemp5 .= '
			<li><a href="' . $__templater->func('link', array('account/connected-accounts', ), true) . '" class="menu-linkRow">' . 'Kết nối tài khoản' . '</a></li>
		';
	}
	$__compilerTemp6 = '';
	...
	<ul class="listPlain listColumns listColumns--narrow listColumns--together">
		...
		<li><a href="' . $__templater->func('link', array('account/reactions', ), true) . '" class="menu-linkRow">' . 'Điểm tương tác nhận được' . '</a></li>
		' . '
	</ul>
	...
	<ul class="listPlain listColumns listColumns--narrow listColumns--together">
		' . '
		<li><a href="' . $__templater->func('link', array('account/account-details', ), true) . '" class="menu-linkRow">' . 'Chi tiết tài khoản' . '</a></li>
		...
		<li><a href="' . $__templater->func('link', array('account/ignored', ), true) . '" class="menu-linkRow">' . 'Phớt lờ' . '</a></li>
		' . '
	</ul>
...
';
	...
	<ul class="tabPanes">
		...
		<li role="tabpanel" id="uix_conversationsMenuPanel"
			data-href="' . $__templater->func('link', array('conversations/popup', ), true) . '"
			data-load-target=".js-uix_conversationsMenuBody"
			data-nocache="true">
			<div class="js-uix_conversationsMenuBody">
		...
		<li role="tabpanel" id="uix_alertsMenuPanel"
			data-href="' . $__templater->func('link', array('account/alerts-popup', ), true) . '"
			data-load-target=".js-uix_alertsMenuBody"
			data-nocache="true">
			<div class="js-uix_alertsMenuBody">
				<div class="menu-row">' . 'Đang tải' . $__vars['xf']['language']['ellipsis'] . '</div>
			</div>
			<div class="menu-footer menu-footer--split">
				<div class="menu-footer-main">
		...
		if ($__templater->method($__vars['xf']['visitor'], 'canViewBookmarks', array())) {
			...
			<li role="tabpanel" id="' . $__templater->func('unique_id', array('accountMenuBookmarks', ), true) . '"
				...
				<div class="menu-footer menu-footer--close">
					<a href="' . $__templater->func('link', array('account/bookmarks', ), true) . '" class="js-bookmarkShowAllLink">' . 'Xem tất cả' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</li>
		';
		}
