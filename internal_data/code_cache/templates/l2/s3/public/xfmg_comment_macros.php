<?php
// FROM HASH: 8f0196b41cfea0b1f6e88024d21096c6
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['comment']['last_edit_date']) {
		...
		if ($__vars['comment']['user_id'] == $__vars['comment']['last_edit_user_id']) {
			$__finalCompiled .= '
									' . 'Chỉnh sửa lần cuối' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('date_dynamic', array($__vars['comment']['last_edit_date'], array(
			))) . '
								';
		} else {
			$__finalCompiled .= '
									' . 'Chỉnh sửa lần cuối bởi người điều hành' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('date_dynamic', array($__vars['comment']['last_edit_date'], array(
			))) . '
								';
		}
		$__finalCompiled .= '
	...
	if ($__templater->method($__vars['content'], 'canReplyToComment', array())) {
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														title="' . $__templater->filter('Trả lời, trích dẫn nội dung bài viết này', array(array('for_attr', array()),), true) . '"
														data-xf-click="quote"
														data-quote-href="' . $__templater->func('link', array('media/comments/quote', $__vars['comment'], ), true) . '">' . 'Trả lời' . '</a>
												';
	}
	$__compilerTemp2 .= '
											';
	...
	if ($__templater->method($__vars['comment'], 'canUseInlineModeration', array())) {
		$__compilerTemp3 .= '
			...
			'title' => 'Chọn để quản trị',
			'label' => 'Chọn để quản trị',
			'hiddenlabel' => 'true',
			'_type' => 'option',
		))) . '
													</span>
	...
	if ($__templater->method($__vars['comment'], 'canReport', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('media/comments/report', $__vars['comment'], ), true) . '" class="actionBar-action actionBar-action--report" data-xf-click="overlay">' . 'Báo cáo' . '</a>
												';
	}
	$__compilerTemp3 .= '
												';
	...
	if ($__vars['comment']['edit_count'] AND $__templater->method($__vars['comment'], 'canViewHistory', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('media/comments/history', $__vars['comment'], ), true) . '" class="actionBar-action actionBar-action--history" data-xf-click="toggle" data-target="< .js-comment | .js-historyTarget">' . 'Lịch sử' . '</a>
												';
	}
	$__compilerTemp3 .= '
												';
	if ($__templater->method($__vars['comment'], 'canDelete', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('media/comments/delete', $__vars['comment'], ), true) . '" class="actionBar-action actionBar-action--delete" data-xf-click="overlay">' . 'Xóa' . '</a>
												';
	}
	$__compilerTemp3 .= '
												';
	...
	if ($__templater->method($__vars['comment'], 'canWarn', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('media/comments/warn', $__vars['comment'], ), true) . '" class="actionBar-action actionBar-action--warn">' . 'Cảnh cáo' . '</a>
												';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['comment'], 'canEdit', array())) {
		...
		$__compilerTemp2 .= '
														<a href="' . $__templater->func('link', array('media/comments/edit', $__vars['comment'], array('lightbox' => 1, ), ), true) . '"
															...
															data-xf-click="quick-edit"
															data-editor-target="[data-content=xfmg-comment-' . $__templater->escape($__vars['comment']['comment_id']) . '] .js-quickEditTarget">' . 'Sửa' . '</a>
													';
	}
	$__compilerTemp2 .= '
	...
	if ($__vars['comment']['edit_count'] AND $__templater->method($__vars['comment'], 'canViewHistory', array())) {
		$__compilerTemp2 .= '
														<a href="' . $__templater->func('link', array('media/comments/history', $__vars['comment'], ), true) . '" class="menu-linkRow" data-xf-click="toggle" data-menu-closer="true" data-target="[data-content=xfmg-comment-' . $__templater->escape($__vars['comment']['comment_id']) . '] .js-historyTarget">' . 'Lịch sử' . '</a>
													';
	}
	$__compilerTemp2 .= '
	...
	if ($__templater->method($__vars['comment'], 'canDelete', array())) {
		$__compilerTemp2 .= '
														<a href="' . $__templater->func('link', array('media/comments/delete', $__vars['comment'], ), true) . '" class="menu-linkRow" data-xf-click="overlay">' . 'Xóa' . '</a>
													';
	}
	$__compilerTemp2 .= '
	...
	if ($__templater->method($__vars['comment'], 'canWarn', array())) {
		$__compilerTemp2 .= '
														<a href="' . $__templater->func('link', array('media/comments/warn', $__vars['comment'], ), true) . '" class="menu-linkRow">' . 'Cảnh cáo' . '</a>
													';
	} else if ($__vars['comment']['warning_id'] AND $__templater->method($__vars['xf']['visitor'], 'canViewWarnings', array())) {
		$__compilerTemp2 .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<section class="message message--simple message--deleted message--comment' . ($__templater->method($__vars['comment'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-comment js-inlineModContainer"
		...
		'log' => $__vars['comment']['DeletionLog'],
					...
					<a href="' . $__templater->func('link', array('media/comments/show', $__vars['comment'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=xfmg-comment-' . $__templater->escape($__vars['comment']['comment_id']) . ']">' . 'Hiện' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</div>
		</div>
	</section>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="message-responseRow">
		...
		'log' => $__vars['comment']['DeletionLog'],
							...
							<a href="' . $__templater->func('link', array('media/comments/show', $__vars['comment'], array('lightbox' => 1, ), ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=xfmg-comment-' . $__templater->escape($__vars['comment']['comment_id']) . ']">' . 'Hiện' . $__vars['xf']['language']['ellipsis'] . '</a>
						</div>
					</div>
					<div class="comment-actionBar actionBar">
						<div class="actionBar-set actionBar-set--internal">
