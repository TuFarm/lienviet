<?php
// FROM HASH: 420347ef75a493bcf642bcb81caea556
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (($__vars['xf']['options']['forumsDefaultPage'] != 'forums') OR ($__vars['xf']['options']['indexRoute'] AND ($__vars['xf']['options']['indexRoute'] != 'forums/'))) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Lựa chọn chuyên mục');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageH1'] = $__templater->preEscaped('Lựa chọn chuyên mục');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
