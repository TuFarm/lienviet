...
[EMAIL=example@example.com]Email me[/EMAIL]', array(array('preEscaped', array()),), false),
		...
		'example' => $__templater->filter('[USER=' . ($__vars['xf']['visitor']['user_id'] ? $__templater->escape($__vars['xf']['visitor']['user_id']) : '1') . ']' . 'Tên tài khoản' . '[/USER]', array(array('preEscaped', array()),), false),
		'anchor' => 'user-mention',
	), $__vars) . '
		...
		'anchor' => 'image',
			...
			<li class="bbCodeHelpItem block-row block-row--separated">
				...
				<div>
					...
					' . 'Trang được cho phép' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('media_sites', array(), true) . '
				</div>
				<div class="bbCodeDemoBlock">
					<dl class="bbCodeDemoBlock-item">
						<dt>' . 'Ví dụ' . $__vars['xf']['language']['label_separator'] . '</dt>
...
[/TABLE]', array(array('preEscaped', array()),), false),
		'anchor' => 'table',
			...
			' . $__templater->callMacro(null, 'row_output', array(
		'title' => $__templater->filter('[HEADING=<span class="block-textHeader-highlight">level</span>] - Headings levels 1 to 3', array(array('preEscaped', array()),), false),
		'desc' => $__templater->filter('Marks text as a structured heading to facilitate machine readability.', array(array('preEscaped', array()),), false),
...
If you require additional subdivision, you may drop to level 3.', array(array('preEscaped', array()),), false),
		'anchor' => 'heading',
	), $__vars) . '
