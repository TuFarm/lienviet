...
{
	$__finalCompiled = '';
	$__finalCompiled .= '' . ($__templater->escape($__vars['user']['username']) ?: $__templater->escape($__vars['alert']['username'])) . ' phản ứng với tin nhắn của bạn trong cuộc trò chuyện ' . $__templater->escape($__vars['content']['Conversation']['title']) . ' với ' . $__templater->func('reaction_title', array($__vars['extra']['reaction_id'], ), true) . '.' . '
