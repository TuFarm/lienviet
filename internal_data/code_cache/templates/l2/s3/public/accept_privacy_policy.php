...
<div class="blockMessage blockMessage--iconic blockMessage--important">
	' . 'Please read and accept our privacy policy before continuing.' . ' ' . 'Cập nhật lần cuối' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('date_dynamic', array($__vars['xf']['options']['privacyPolicyLastUpdate'], array(
	))) . '.
</div>
