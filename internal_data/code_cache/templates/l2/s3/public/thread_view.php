<?php
// FROM HASH: 4f2a8676d39b3982c4f4f627b31adee8
return array(
...
'thread_action_buttons' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['thread'], 'canCreatePoll', array())) {
		$__compilerTemp2 .= '
												<a href="' . $__templater->func('link', array('threads/poll/create', $__vars['thread'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Tạo khảo sát' . '</a>
											';
	}
	$__compilerTemp2 .= '
											';
	...
	if ($__templater->method($__vars['thread'], 'canReplyBan', array())) {
		$__compilerTemp2 .= '
												<a href="' . $__templater->func('link', array('threads/reply-bans', $__vars['thread'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Quản lý phản hồi bị cấm' . '</a>
											';
	}
	$__compilerTemp2 .= '
											';
	if ($__templater->method($__vars['thread'], 'canViewModeratorLogs', array())) {
		$__compilerTemp2 .= '
												<a href="' . $__templater->func('link', array('threads/moderator-actions', $__vars['thread'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Hành vi quản trị' . '</a>
											';
	}
	$__compilerTemp2 .= '
											' . '
...
';
	...
	if ($__templater->method($__vars['thread'], 'canReply', array())) {
		$__compilerTemp1 .= '
		' . $__templater->button('Trả lời', array(
