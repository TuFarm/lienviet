...
';
		...
		$__finalCompiled .= '
	' . 'Bài viết trên hồ sơ của ' . (((('<a href="' . $__templater->func('base_url', array($__vars['extra']['link'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['extra']['profileUser'])) . '</a>') . ' được sửa.' . '
';
	}
	$__finalCompiled .= '
';
