...
jQuery.extend(XF.phrases, {
	...
	s2_input_too_short: "' . $__templater->filter('Vui lòng nhập {count} hoặc nhiều ký tự hơn.', array(array('escape', array('js', )),), false) . '",
	...
	s2_no_results: "' . $__templater->filter('Không có kết quả.', array(array('escape', array('js', )),), false) . '",
