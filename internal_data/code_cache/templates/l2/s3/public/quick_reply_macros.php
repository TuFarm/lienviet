<?php
// FROM HASH: dbe2c54022f4d4765acbce5683c3b8ce
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
							';
	if ($__templater->func('property', array('uix_postBitAvatarSize', ), false) == 'large') {
		$__finalCompiled .= '
								' . $__templater->func('avatar', array($__vars['user'], ($__vars['simple'] ? 's' : 'l'), false, array(
			'defaultname' => '',
		))) . '
							';
	} else if ($__templater->func('property', array('uix_postBitAvatarSize', ), false) == 'small') {
		$__finalCompiled .= '
								' . $__templater->func('avatar', array($__vars['user'], ($__vars['simple'] ? 's' : 's'), false, array(
			'defaultname' => '',
		))) . '
							';
	} else {
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="formButtonGroup ' . ($__vars['simpleSubmit'] ? 'formButtonGroup--simple' : '') . '">
		<div class="formButtonGroup-primary">
			' . $__templater->button('
				' . ($__templater->escape($__vars['submitText']) ?: 'Trả lời') . '
			', array(
		'type' => 'submit',
