...
';
	...
	<ul class="listInline listInline--bullet">
		...
		'title' => $__templater->filter('Những người tham gia', array(array('for_attr', array()),), false),
	)) . '
			<span class="u-srOnly">' . 'Những người tham gia' . '</span>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-minorHeader">' . 'Thông tin đối thoại' . '</h3>
			<div class="block-body block-row block-row--minor">
				<dl class="pairs pairs--justified"><dt>' . 'Những người tham gia' . '</dt> <dd>' . $__templater->filter($__vars['conversation']['recipient_count'], array(array('number', array()),), true) . '</dd></dl>
...
';
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-minorHeader">' . 'Những người tham gia đối thoại' . '</h3>
			<ol class="block-body">
				' . $__compilerTemp3 . '
			</ol>
			' . $__compilerTemp4 . '
