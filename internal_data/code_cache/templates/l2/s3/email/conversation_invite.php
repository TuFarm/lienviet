...
' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->escape($__vars['sender']['username']) . ' added you to an existing personal conversation at ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
