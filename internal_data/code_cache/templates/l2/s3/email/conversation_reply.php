...
' . '<p>' . $__templater->escape($__vars['receiver']['username']) . ', ' . (((('<a href="' . $__templater->func('link', array('canonical:members', $__vars['sender'], ), true)) . '">') . $__templater->escape($__vars['sender']['username'])) . '</a>') . ' trả lời cuộc trò chuyện cá nhân của bạn tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
