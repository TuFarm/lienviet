...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . '' . ($__templater->func('prefix', array('thread', $__vars['thread'], 'escaped', ), true) . $__templater->escape($__vars['thread']['title'])) . ' - Phản hồi mới cho chủ đề được theo dõi' . '
</mail:subject>

' . '' . $__templater->escape($__vars['receiver']['username']) . ', ' . $__templater->func('username_link_email', array($__vars['post']['User'], $__vars['post']['username'], ), true) . ' đã trả lời vào chủ đề bạn đang xem tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.' . '
