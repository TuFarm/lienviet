...
<p>Để hoàn tất đăng nhập vào tài khoản của bạn (hoặc hoàn thành thiết lập xác minh hai bước) tại ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ', bạn phải nhập mã sau đây:</p>' . '
