<?php
// FROM HASH: 8ad7a9cb7df163c8502660db44dc0b99
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Đăng ký bằng ' . $__templater->escape($__vars['provider']['title']) . '');
	$__finalCompiled .= '
		...
		<ul class="tabPanes">
			...
			<li role="tabpanel" id="' . $__templater->func('unique_id', array('regAssoc', ), true) . '">
				<div class="block-body block-row">
					' . 'Để liên kết với tài khoản sẵn có, bạn phải đăng nhập vào tài khoản đó trước và bắt đầu quá trình liên kết tại <a href="' . $__templater->func('link', array('account/connected-accounts', ), true) . '">khu vực tài khoản liên kết</a>.' . '
				</div>
			</li>
		</ul>
	</div>
