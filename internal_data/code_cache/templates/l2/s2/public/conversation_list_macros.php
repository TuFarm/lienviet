<?php
// FROM HASH: 3208badc9831ba63240febde9c7688d0
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['userConv']['is_starred']) {
		$__compilerTemp1 .= '
						<li>
							<i class="structItem-status structItem-status--starred" aria-hidden="true" title="' . $__templater->filter('Đã đánh dấu sao', array(array('for_attr', array()),), true) . '"></i>
							<span class="u-srOnly">' . 'Đã đánh dấu sao' . '</span>
						</li>
					';
	}
	$__compilerTemp1 .= '
