<?php
// FROM HASH: aa4f56e8b047e1dc02c5415880c2c0bf
return array(
	...
	if ($__templater->method($__vars['resource'], 'canViewTeamMembers', array()) AND ($__vars['update']['team_user_id'] AND ($__vars['update']['team_user_id'] != $__vars['resource']['user_id']))) {
		$__finalCompiled .= '
							<div class="message-lastEdit">
								' . 'Đăng bởi' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->func('username_link', array($__vars['update']['TeamUser'], false, array(
