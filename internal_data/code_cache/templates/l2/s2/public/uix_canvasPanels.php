	...
	if ($__vars['xf']['visitor']['user_id'] AND ($__templater->func('property', array('uix_visitorTabsMobile', ), false) == 'canvas')) {
		...
		<div data-content="inbox" class="sidePanel__tabPanel js-convoTabPanel">
				...
				<div class="menu-footer">
					<a href="' . $__templater->func('link', array('conversations/add', ), true) . '" class="u-pullRight">' . 'Bắt đầu đối thoại mới' . '</a>
		...
		<div data-content="alerts" class="sidePanel__tabPanel js-alertTabPanel">
				...
				<div class="menu-footer menu-footer--split">
					<span class="menu-footer-main">
						<a href="' . $__templater->func('link', array('account/alerts', ), true) . '">' . 'Xem tất cả' . $__vars['xf']['language']['ellipsis'] . '</a>
					</span>
					<span class="menu-footer-opposite">
						<a href="' . $__templater->func('link', array('account/preferences', ), true) . '">' . 'Tùy chọn' . '</a>
					</span>
				</div>
		</div>
