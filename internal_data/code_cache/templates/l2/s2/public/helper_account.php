...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['showExplain']) {
		$__compilerTemp2 .= 'Bạn có thể tham khảo tùy chọn thư ở mục <a href="' . $__templater->func('link', array('account/preferences', ), true) . '">Tùy chọn</a>.';
	}
