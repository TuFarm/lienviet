<?php
// FROM HASH: 8ca424f07bcfa722391d5946c5ab6a74
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
';
	$__templater->setPageParam('uix_mobileActiveNav', 'Tìm kiếm');
	$__finalCompiled .= '
...
';
	...
	if ($__vars['xf']['options']['enableTagging']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->func('link', array('tags', ), true) . '" class="tabs-tab">' . 'Tìm kiếm theo thẻ' . '</a>
				';
	}
