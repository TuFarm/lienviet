<?php
// FROM HASH: 9c25b76f33c2085686884ed0e99958a7
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
								...
								<div class="offCanvasMenu-linkHolder ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="alerts" href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="offCanvasMenu-link">' . 'Thông báo' . '</a></div></div>
								<div class="offCanvasMenu-linkHolder ' . (($__vars['uix_myAccountLinks'] == 'settings') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="settings" href="' . $__templater->func('link', array('account/preferences', ), true) . '" class="offCanvasMenu-link">' . 'Thiết lập' . '</a></div></div>
							';
	}
	$__finalCompiled .= '
							';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['nav']['counter']) {
		$__finalCompiled .= ' <span class="badge badge--highlighted' . ((($__vars['navId'] == 'siropuChat') AND ($__vars['nav']['counter'] >= 1)) ? ' badge--active' : '') . '">' . $__templater->filter($__vars['nav']['counter'], array(array('number', array()),), true) . '</span>';
	}
...
';
	if ($__templater->func('property', array('uix_visitorTabsMobile', ), false) == 'tabbar') {
		$__finalCompiled .= '
	';
		$__vars['uix_htmlClasses'] = $__templater->preEscaped($__templater->escape($__vars['uix_htmlClasses']) . ' uix_hasBottomTabs');
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
		...
		if ($__templater->method($__vars['xf']['visitor'], 'canSearch', array())) {
			...
			$__compilerTemp2 .= $__templater->formCheckBox(array(
				...
				'icon' => 'search',
								...
								' . $__templater->button('Tìm nâng cao' . $__vars['xf']['language']['ellipsis'], array(
...
';
	...
	';
		...
		if (($__vars['xf']['visitor']['user_state'] == 'rejected') OR ($__vars['xf']['visitor']['user_state'] == 'disabled')) {
			...
			$__compilerTemp9 .= '
			<a href="' . $__templater->func('link', array('account', ), true) . '"
			   data-badge="' . $__templater->escape($__vars['uix_badgeCounter']) . '"
			   class="p-navgroup-link u-ripple p-navgroup-link--iconic p-navgroup-link--user js-uix_badge--totalUnread badgeContainer' . (($__vars['xf']['visitor']['alerts_unviewed'] OR $__vars['xf']['visitor']['conversations_unread']) ? ' badgeContainer--highlighted' : '') . '"
			   data-xf-click="menu"
			...
			<a href="' . $__templater->func('link', array('conversations', ), true) . '"
			   ...
			   data-xf-key="' . $__templater->filter(',', array(array('for_attr', array()),), true) . '"
			   data-menu-pos-ref="< .p-navgroup"
			   title="' . $__templater->filter('Đối thoại', array(array('for_attr', array()),), true) . '"
					...
					<div class="menu-footer menu-footer--split">
						<div class="menu-footer-main">
							<ul class="listInline listInline--bullet">
								<li><a href="' . $__templater->func('link', array('conversations', ), true) . '">' . 'Xem tất cả' . '</a></li>
								';
			if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
				$__compilerTemp9 .= '
									<li><a href="' . $__templater->func('link', array('conversations/add', ), true) . '">' . 'Bắt đầu đối thoại mới' . '</a></li>
								';
			}
			$__compilerTemp9 .= '
							</ul>
			...
			<div class="menu menu--structural menu--medium" data-menu="menu" aria-hidden="true"
				...
				<div class="menu-content">
					...
					<div class="menu-footer menu-footer--split">
						<div class="menu-footer-main">
							<ul class="listInline listInline--bullet">
								<li><a href="' . $__templater->func('link', array('account/alerts', ), true) . '">' . 'Xem tất cả' . '</a></li>
								<li><a href="' . $__templater->func('link', array('account/alerts/mark-read', ), true) . '" class="js-alertsMarkRead">' . 'Đánh dấu đã xem' . '</a></li>
	...
	if ($__vars['sidebar']) {
		...
		<div uix_component="MainSidebar" class="p-body-sidebar">
			...
			'showWelcomeSection' => $__vars['uix_showWelcomeSection'],
					...
					' . $__templater->widgetPosition('siropu_chat_sidebar_top', array(
...
';
		...
		$__compilerTemp16 .= '
' . $__templater->widgetPosition('siropu_chat_sidebar_bottom', array(
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__compilerTemp31 .= '
					<ul class="uix_sidebarNavList">
						...
						<li><div class="p-navEl ' . (($__vars['uix_myAccountLinks'] == 'alerts') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="alerts" href="' . $__templater->func('link', array('account/alerts', ), true) . '" class="p-navEl-link"><span>' . 'Thông báo' . '</span></a></div></div></li>
						<li><div class="p-navEl ' . (($__vars['uix_myAccountLinks'] == 'settings') ? 'is-selected' : '') . '"><div class="p-navEl__inner u-ripple"><a data-nav-id="settings" href="' . $__templater->func('link', array('account/preferences', ), true) . '" class="p-navEl-link"><span>' . 'Thiết lập' . '</span></a></div></div></li>
					</ul>
				';
	}
	$__compilerTemp32 = '';
...
';
	...
	' . $__templater->widgetPosition('siropu_chat_below_breadcrumb', array(
...
';
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeStyle', array()) AND (!$__templater->func('property', array('uix_hideStyleChoose', ), false))) {
		$__compilerTemp46 .= '
										<li><a href="' . $__templater->func('link', array('misc/style', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . 'Chọn giao diện' . '" rel="nofollow">' . $__templater->escape($__vars['xf']['style']['title']) . '</a></li>
									';
	}
	$__compilerTemp46 .= '
									';
	if ($__templater->method($__vars['xf']['visitor'], 'canChangeLanguage', array())) {
		$__compilerTemp46 .= '
										<li><a href="' . $__templater->func('link', array('misc/language', ), true) . '" data-xf-click="overlay" data-xf-init="tooltip" title="' . 'Chọn Ngôn ngữ' . '" rel="nofollow"><i class="fa fa-globe" aria-hidden="true"></i> ' . $__templater->escape($__vars['xf']['language']['title']) . '</a></li>
									';
	}
	$__compilerTemp46 .= '
								';
	...
	if (!$__vars['uix_hideNavigation']) {
		...
		$__compilerTemp59 .= '
									' . $__templater->button('
										<i aria-hidden="true"></i>
									', array(
			'class' => 'button--plain p-nav-menuTrigger ' . ($__vars['uix_visitorTabCanvas'] ? 'js-uix_badge--totalUnread' : '') . ' badgeContainer' . (($__vars['uix_visitorTabCanvas'] AND ($__vars['xf']['visitor']['alerts_unviewed'] OR $__vars['xf']['visitor']['conversations_unread'])) ? ' badgeContainer--highlighted' : ''),
			'data-badge' => $__templater->filter($__vars['uix_badgeCounter'], array(array('number', array()),), false),
			'data-xf-click' => 'off-canvas',
			'data-menu' => '.js-headerOffCanvasMenu',
			'role' => 'button',
			'tabindex' => '0',
			'aria-label' => $__templater->filter('Trình đơn', array(array('for_attr', array()),), false),
		), '', array(
		)) . '
									';
...
';
	...
	$__finalCompiled .= '
		...
		'content' => $__vars['uix_mainTabComponent'],
									...
									' . $__templater->widgetPosition('siropu_chat_above_content', array(
...
' . $__templater->widgetPosition('siropu_chat_below_content', array(
	...
	if ($__templater->func('property', array('scrollJumpButtons', ), false)) {
		...
		)) . '<span class="u-srOnly">' . 'Bên trên' . '</span>', array(
			'href' => '#top',
