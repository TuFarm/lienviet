<?php
// FROM HASH: 02065e81038b27800a768874d9572fae
return array(
...
<div class="blocks">
		...
		$__compilerTemp4 .= '
			<div class="block-outer block-outer--after uix_login__registerLink">
				<div class="block-outer-middle">
					' . 'Chưa có tài khoản?' . ' <a href="' . $__templater->func('link', array('register', ), true) . '">' . 'Đăng ký ngay' . '</a>
				</div>
			</div>
		';
	}
	$__finalCompiled .= $__templater->form('
		...
		'label' => 'Mật khẩu',
		'html' => '
						<a class="uix_forgotPassWord__link" href="' . $__templater->func('link', array('lost-password', ), true) . '" data-xf-click="overlay">' . 'Bạn đã quên mật khẩu?' . '</a>
					',
	)) . '
