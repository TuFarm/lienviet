<?php
// FROM HASH: c0669b443efa37d772d40c87a47f39f7
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Đối thoại');
...
';
	...
	' . $__templater->button('Bắt đầu đối thoại', array(
...
<div class="block" data-xf-init="inline-mod" data-type="conversation" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	if (!$__templater->test($__vars['userConvs'], 'empty', array())) {
		...
		$__finalCompiled .= '
				<div class="block-row">' . 'Chưa có đối thoại nào để hiển thị.' . '</div>
			';
	}
	$__finalCompiled .= '
		</div>
		<div class="block-footer block-footer--split uix_conversationsFooterMobile">
			<div class="block-footer-main">
				<a href="' . $__templater->func('link', array('conversations', ), true) . '">' . 'Xem tất cả' . $__vars['xf']['language']['ellipsis'] . '</a>
			</div>
			';
	if ($__templater->method($__vars['xf']['visitor'], 'canStartConversation', array())) {
		$__finalCompiled .= '
				<div class="block-footer-opposite">
					<a href="' . $__templater->func('link', array('conversations/add', ), true) . '">' . 'Bắt đầu đối thoại mới' . '</a>					
				</div>
			';
	}
	$__finalCompiled .= '
