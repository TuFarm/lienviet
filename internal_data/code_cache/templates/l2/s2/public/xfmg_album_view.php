<?php
// FROM HASH: 2b38efe0dd0380f1dfc2d7f9fbd80ff9
return array(
...
<div class="block" data-xf-init="' . ($__vars['canInlineModMediaItems'] ? 'inline-mod' : '') . '" data-type="xfmg_media" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	if ($__templater->method($__vars['album'], 'canViewModeratorLogs', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->func('link', array('media/albums/moderator-actions', $__vars['album'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Hành vi quản trị' . '</a>
													';
	}
	$__compilerTemp7 .= '
													' . '
