	...
	';
		...
		<div class="block" data-widget-section="staffMembers"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
			<div class="block-container">
				<h3 class="block-minorHeader"><a href="' . $__templater->func('link', array('members', null, array('key' => 'staff_members', ), ), true) . '">' . 'Nhân viên trực tuyến' . '</a></h3>
				<ul class="block-body">
				' . $__compilerTemp1 . '
				</ul>
			</div>
...
<div class="block" data-widget-section="onlineNow"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
	...
	$__finalCompiled .= '
		...
		<div class="block-footer">
			<span class="block-footer-counter">' . 'Đang trực tuyến: ' . $__templater->func('number', array($__vars['online']['counts']['total'], ), true) . ' (Thành viên: ' . $__templater->func('number', array($__vars['online']['counts']['members'], ), true) . ', Khách: ' . $__templater->func('number', array($__vars['online']['counts']['guests'], ), true) . ')' . '</span>
		</div>
	</div>
</div>';
