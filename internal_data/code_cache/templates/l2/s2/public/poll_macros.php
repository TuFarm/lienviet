<?php
// FROM HASH: ce772db420e89c23f49d54674793d782
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['poll']['public_votes']) {
		$__compilerTemp3 .= '
						<li>' . 'Bầu chọn của bạn sẽ được hiển thị công khai.' . '</li>
					';
	}
	$__compilerTemp3 .= '
				';
	...
	<div class="block-footer">
		<span class="block-footer-controls">
			' . $__templater->button('Bầu chọn', array(
		'type' => 'submit',
	...
	if ($__templater->method($__vars['poll'], 'canViewResults', array())) {
		$__finalCompiled .= '
				' . $__templater->button('Hiện kết quả', array(
				...
				if ($__vars['canShowVoters']) {
					$__finalCompiled .= '
									<a class="fauxBlockLink-blockLink"
										...
										role="button"
										tabindex="0">
										<span class="u-muted">' . 'Số phiếu' . $__vars['xf']['language']['label_separator'] . '</span> ' . $__templater->filter($__vars['response']['response_vote_count'], array(array('number', array()),), true) . '
									</a>
								';
				} else {
					$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= $__templater->formRadioRow(array(
		...
		'label' => 'Số lượng đáp án tối đa',
		'explain' => 'Đây là số lượng đáp án tối đa mà một người có thể lựa chọn.',
		'rowtype' => $__vars['rowType'],
	)) . '
	...
	$__compilerTemp4 = array(array(
		...
		'label' => '
			' . 'Cho phép người dùng thay đổi đáp án' . '
		',
		'_type' => 'option',
	));
	...
	$__compilerTemp4[] = array(
		...
		'label' => '
			' . 'Cho phép hiển thị kết quả mà không cần bầu chọn' . '
		',
		'_type' => 'option',
	);
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['poll']['voter_count']) {
		$__compilerTemp1[] = array(
			'value' => 'reset',
			'label' => 'Đặt lại tất cả các phiếu bầu',
			'_type' => 'option',
		);
	}
	$__compilerTemp1[] = array(
