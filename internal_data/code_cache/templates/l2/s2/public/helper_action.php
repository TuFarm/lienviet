...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['checkbox'] = $__templater->preEscaped('
		...
		'label' => 'Notify author of this action.' . ' ' . 'Lý do' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => $__vars['reasonName'],
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	' . $__templater->formCheckBoxRow(array(
		...
		'name' => $__vars['alertName'],
		'selected' => $__vars['selected'],
		'label' => 'Notify thread starter of this action.' . ' ' . 'Lý do' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(
		'name' => $__vars['reasonName'],
		'placeholder' => 'Optional',
	))),
