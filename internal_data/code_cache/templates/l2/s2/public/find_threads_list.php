<?php
// FROM HASH: 668096eb6a8e24fdad9e8b26444e13a3
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'contributed') ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('find-threads/contributed', ), true) . '" rel="nofollow">' . 'Chủ đề có bài của bạn' . '</a>
	...
	<a class="' . $__templater->escape($__vars['baseClass']) . ' ' . (($__vars['pageSelected'] == 'watched') ? $__templater->escape($__vars['selectedClass']) : '') . '"
		href="' . $__templater->func('link', array('watched/threads', ), true) . '" rel="nofollow">' . 'Theo dõi' . '</a>
';
	return $__finalCompiled;
}
)),
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['pageSelected'] == 'started') {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Chủ đề bắt đầu bởi ' . $__templater->escape($__vars['user']['username']) . '');
...
';
		...
		$__finalCompiled .= '
	<div class="blockMessage">' . 'Không có chủ đề.' . '</div>
';
	}
	$__finalCompiled .= '
