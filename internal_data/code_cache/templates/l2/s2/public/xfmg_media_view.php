<?php
// FROM HASH: f14b2bf5cd951bcb2251bbebd4ca0644
return array(
...
<div class="block js-mediaInfoBlock">
	...
	if ($__templater->method($__vars['mediaItem'], 'canViewModeratorLogs', array())) {
		$__compilerTemp7 .= '
														<a href="' . $__templater->func('link', array('media/moderator-actions', $__vars['mediaItem'], ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Hành vi quản trị' . '</a>
													';
	}
	$__compilerTemp7 .= '
													' . '
