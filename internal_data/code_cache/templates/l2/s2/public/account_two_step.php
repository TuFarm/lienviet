...
';
	...
	<div class="block">
		...
		if ($__vars['currentTrustRecord']) {
			$__finalCompiled .= '
					<div class="block-row block-row--separated">
						' . 'Thiết bị này hiện được tin cậy cho đến ' . $__templater->func('date', array($__vars['currentTrustRecord']['trusted_until'], ), true) . '. Bạn sẽ không cần phải hoàn thành xác minh hai bước từ thiết bị này cho đến lúc đó. Bạn có thể chọn ngừng tin tưởng thiết bị này để bạn sẽ được nhắc hoàn thành xác minh hai bước khi bạn đăng nhập lần sau.' . '
