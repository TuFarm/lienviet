...
<div class="menu-scroller js-emojiFullList">
	<h3 class="menu-header js-recentHeader ' . ((!$__vars['recent']) ? 'is-hidden' : '') . '">' . 'Sử dụng gần đây' . '</h3>
	...
	if ($__templater->isTraversable($__vars['smilieCategories'])) {
		...
		';
			...
			if (strlen(trim($__compilerTemp1)) > 0) {
				$__finalCompiled .= '
			<h3 class="menu-header">' . ($__vars['categoryId'] ? $__templater->escape($__vars['category']['title']) : 'Mặt cười') . '</h3>
			<div class="menu-row">
