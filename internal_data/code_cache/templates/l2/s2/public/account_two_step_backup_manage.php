...
';
	...
	<div class="block-container">
		<div class="block-body">
			...
			', array(
		'label' => 'Mã dự phòng',
		'explain' => 'Mỗi mã này có thể được sử dụng một lần trong trường hợp bạn không có quyền truy cập vào các phương tiện xác minh khác. Các mã này nên được lưu ở một vị trí an toàn.',
	)) . '
		...
		'hint' => 'Điều này sẽ tạo mã dự phòng mới. Tất cả mã cũ sẽ không hoạt động nữa.',
		'_type' => 'option',
	)), array(
	)) . '
		</div>
