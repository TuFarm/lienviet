	...
	<script class="js-editorLanguage" type="application/json">
		{
			...
			"Align": "' . $__templater->filter('Căn hàng', array(array('escape', array('json', )),), true) . '",
			"Alignment": "' . $__templater->filter('Căn hàng', array(array('escape', array('json', )),), true) . '",
			...
			"Clear Formatting": "' . $__templater->filter('Xóa bỏ định dạng', array(array('escape', array('json', )),), true) . '",
			...
			"Insert Image": "' . $__templater->filter('Chèn ảnh', array(array('escape', array('json', )),), true) . '",
			...
			"Ordered List": "' . $__templater->filter('Danh sách đánh số thứ tự', array(array('escape', array('json', )),), true) . '",
			...
			"Redo": "' . $__templater->filter('Sửa lại', array(array('escape', array('json', )),), true) . '",
			"Remove": "' . $__templater->filter('Xóa bỏ', array(array('escape', array('json', )),), true) . '",
			...
			"Toggle BB Code": "' . $__templater->filter('Tắt/Bật mã BB', array(array('escape', array('json', )),), true) . '",
			"Underline": "' . $__templater->filter('Gạch dưới', array(array('escape', array('json', )),), true) . '",
			"Undo": "' . $__templater->filter('Làm lại', array(array('escape', array('json', )),), true) . '",
			"Unlink": "' . $__templater->filter('Bỏ liên kết', array(array('escape', array('json', )),), true) . '",
			"Unordered List": "' . $__templater->filter('Danh sách không sắp xếp', array(array('escape', array('json', )),), true) . '",
			...
			"Uploading": "' . $__templater->filter('Đang tải lên', array(array('escape', array('json', )),), true) . '",
			...
			"Table Header": "' . $__templater->filter('Tiêu đề bảng', array(array('escape', array('json', )),), true) . '",
			"Remove Table": "' . $__templater->filter('Xóa bảng', array(array('escape', array('json', )),), true) . '",
			"Row": "' . $__templater->filter('Hàng', array(array('escape', array('json', )),), true) . '",
			"Column": "' . $__templater->filter('Cột', array(array('escape', array('json', )),), true) . '",
			"Insert row above": "' . $__templater->filter('Chèn hàng phía trên', array(array('escape', array('json', )),), true) . '",
			"Insert row below": "' . $__templater->filter('Chèn hàng phía dưới', array(array('escape', array('json', )),), true) . '",
			"Delete row": "' . $__templater->filter('Xóa hàng', array(array('escape', array('json', )),), true) . '",
			"Insert column before": "' . $__templater->filter('Chèn cột phía trước', array(array('escape', array('json', )),), true) . '",
			"Insert column after": "' . $__templater->filter('Chèn cột phía sau', array(array('escape', array('json', )),), true) . '",
			"Delete column": "' . $__templater->filter('Xóa cột', array(array('escape', array('json', )),), true) . '",
			...
			"Change Size": "' . $__templater->filter('Thay đổi kích thước', array(array('escape', array('json', )),), true) . '",
			"None": "' . $__templater->filter('Không có', array(array('escape', array('json', )),), true) . '",
			"Alternative Text": "' . $__templater->filter('Dòng chữ Alt', array(array('escape', array('json', )),), true) . '",
			"__lang end__": ""
		}
	</script>
