...
<p><a href="' . $__templater->func('link', array('canonical:security-lock/reset', $__vars['user'], array('c' => $__vars['confirmation']['confirmation_key'], ), ), true) . '" class="button">' . 'Lấy lại mật khẩu' . '</a></p>';
