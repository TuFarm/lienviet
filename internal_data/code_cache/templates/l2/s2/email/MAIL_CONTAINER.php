<?php
// FROM HASH: f55861e05fd7f15b9df68ae3e8e1bdd1
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '<!DOCTYPE html>
<html lang="' . $__templater->escape($__vars['xf']['language']['language_code']) . '" dir="' . $__templater->escape($__vars['xf']['language']['text_direction']) . '" style="font-size: 62.5%;">
<head>
...
' . $__templater->filter($__vars['html'], array(array('raw', array()),), true) . '
		...
		<tr>
			<td class="footer" align="center" valign="top">
				<div>' . '<a href="' . $__templater->func('link', array('canonical:index', ), true) . '">Ghé thăm ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . '</a>' . '</div>
...
' . 'Ghé thăm ' . $__templater->escape($__vars['xf']['options']['boardTitle']) . ': ' . $__templater->func('link', array('canonical:index', ), true) . '' . '
