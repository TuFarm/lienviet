...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Tìm kiếm theo thẻ');
	$__finalCompiled .= '

';
	$__templater->breadcrumb($__templater->preEscaped('Thẻ'), $__templater->func('link', array('tags', ), false), array(
	));
	$__finalCompiled .= '
...
';
	...
	if ($__vars['xf']['options']['enableTagging']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->func('link', array('tags', ), true) . '" class="tabs-tab is-active">' . 'Tìm kiếm theo thẻ' . '</a>
				';
	}
...
';
	...
	<div class="block">
		<div class="block-container">
			<h3 class="block-header">' . 'Thẻ phổ biến' . '</h3>
