...
';
	...
	<div class="block-container">
		...
		'hint' => 'Kéo hình ảnh này để cắt nó, sau đó nhấp vào <i>Đồng ý</i> để xác nhận hoặc tải lên một hình đại diện mới bên dưới.',
		'_dependent' => array('
		...
		'accept' => '.gif,.jpeg,.jpg,.jpe,.png',
								...
								<dfn class="inputChoices-explain">
									' . 'Bạn nên sử dụng một hình ảnh có kích thước ít nhất ' . 400 . 'x' . 400 . ' pixel.' . '
								</dfn>
							'),
		'_type' => 'option',
	))) . '
