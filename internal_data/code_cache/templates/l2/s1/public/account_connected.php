...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Kết nối tài khoản');
	$__finalCompiled .= '
...
<div class="block">
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formInfoRow('Tài khoản được kết nối cho phép bạn đăng nhập vào trang web này dễ dàng hơn bằng cách sử dụng tài khoản bạn đã giữ tại một trong các trang web bên dưới.', array(
	)) . '
			';
