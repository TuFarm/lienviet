...
';
		...
		$__finalCompiled .= '
	' . 'Bài đăng hồ sơ cho ' . (((('<a href="' . $__templater->func('base_url', array($__vars['extra']['profileLink'], ), true)) . '" class="fauxBlockLink-blockLink">') . $__templater->escape($__vars['extra']['profileUser'])) . '</a>') . ' bị xóa.' . '
';
	}
	$__finalCompiled .= '
';
