...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped(($__vars['isUnread'] ? 'Đánh dấu đã xem' : 'Đánh dấu là chưa đọc'));
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'submit' => ($__vars['isUnread'] ? 'Đánh dấu đã xem' : 'Đánh dấu là chưa đọc'),
	), array(
		'rowtype' => 'simple',
	)) . '
	</div>
