...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['user'], 'canEdit', array())) {
		$__finalCompiled .= '
		<a href="' . $__templater->func('link', array('members/edit', $__vars['user'], ), true) . '" class="menu-linkRow">' . 'Sửa' . '</a>
	';
	}
	$__finalCompiled .= '
	' . '
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canIgnoreUser', array($__vars['user'], ))) {
		$__compilerTemp1 .= '
				<a href="' . $__templater->func('link', array('members/ignore', $__vars['user'], ), true) . '"
					...
					data-xf-click="switch"
					data-sk-ignore="' . $__templater->filter('Phớt lờ', array(array('for_attr', array()),), true) . '"
					data-sk-unignore="' . $__templater->filter('Ngưng phớt lờ', array(array('for_attr', array()),), true) . '">
