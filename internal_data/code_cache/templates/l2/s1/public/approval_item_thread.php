...
' . $__templater->callMacro('approval_queue_macros', 'item_message_type', array(
		...
		'headerPhraseHtml' => 'Chủ đề <a href="' . $__templater->func('link', array('threads', $__vars['content'], ), true) . '">' . $__templater->escape($__vars['content']['title']) . '</a> được đăng trong <a href="' . $__templater->func('link', array('forums', $__vars['content']['Forum'], ), true) . '">' . $__templater->escape($__vars['content']['Forum']['title']) . '</a>',
	), $__vars);
