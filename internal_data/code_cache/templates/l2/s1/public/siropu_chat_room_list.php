		...
		';
			...
			<div class="siropuChatRoomManage">
				...
				if ($__templater->method($__vars['room'], 'canEdit', array())) {
					$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('chat/room/edit', $__vars['room'], ), true) . '" class="siropuChatRoomEdit" title="' . $__templater->filter('Sửa', array(array('for_attr', array()),), true) . '" data-xf-click="overlay" data-cache="false">' . $__templater->fontAwesome('fa-edit', array(
					)) . '<span>' . 'Sửa' . '</span></a>
				';
				}
				$__finalCompiled .= '
				...
				if ($__templater->method($__vars['room'], 'canDelete', array())) {
					$__finalCompiled .= '
					<a href="' . $__templater->func('link', array('chat/room/delete', $__vars['room'], ), true) . '" class="siropuChatRoomDelete" title="' . $__templater->filter('Xóa', array(array('for_attr', array()),), true) . '" data-xf-click="overlay">' . $__templater->fontAwesome('fa-trash', array(
					)) . '<span>' . 'Xóa' . '</span></a>
				';
				}
				$__finalCompiled .= '
