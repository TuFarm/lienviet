<?php
// FROM HASH: a4d4dfe09b5c99e45ea0aee11cddbbfa
return array(
		...
		if ($__vars['style'] == 'full') {
			$__finalCompiled .= '
				<h3 class="block-header">
					<a href="' . $__templater->func('link', array('search-forums', $__vars['searchForum'], ), true) . '">
						' . ($__templater->escape($__vars['title']) ?: $__templater->escape($__vars['searchForum']['title'])) . '
					</a>
				</h3>
...
';
	...
	<div class="blocks" ' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
		';
