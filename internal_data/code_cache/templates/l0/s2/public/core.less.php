<?php
// FROM HASH: 7b89606ea8f9526c524140898f1172b0
return array(
...
//Fix for iOS odd dark mode rendering forcing white background on some inputs
@supports (-webkit-touch-callout: none) {
	input {
		background-color: transparent !important;  
		FILTER: alpha(opacity=0); //this is for Android, but the code for all of this works as a whole so we\'re keeping it just in case it\'s needed later.
